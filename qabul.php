...
<head>
  ...
  <title>
    Qabul - Yangiyo'l tumani 5-sonli Bolalar musiqa va san'at maktabi
  </title>
  <meta
...
<body>
  ...
  <script>
    const main = async () => {
      const response = await fetch('https://www.yangiyol-5bmsm.uz/api/info')
      let { success, data } = await response.json()

      data = data.replaceAll()

      document.querySelector('.row pre').innerHTML = data
    }
